...
unsigned char testverify=ledChip.VerifyProgram(program, (sizeof(program)/2));
    if(testverify==0)
    {
      //Serial.
...
for(unsigned int i=0; i<20000; i++){
	for(unsigned int i=0; i<5000; i++);}
  {
    ...
    //Serial.
    printf("%d",ledChip.GetEnginePC(0));
    printf(" ");
    printf("%d",ledChip.GetEngineMode(0));
    printf(" ");
    printf("%d",ledChip.GetEnginePC(1));
    printf(" ");
    printf("%d",ledChip.GetEngineMode(1));
    printf(" ");
    printf("%d",ledChip.GetEnginePC(2));
    printf(" ");
    printf("%d\n",ledChip.GetEngineMode(2));
